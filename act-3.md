...
2.  Let’s create a conflict in the index.html file so that we can later resolve it:
    ...
    <img src="images/act-3/2.png" alt="" style="float:right;width:180px;">
    ...
    <img src="images/act-3/2-2.png" alt="" style="float:right;width:180px;">
    ...
    <img src="images/act-3/2-3.gif" alt="" style="float:right;width:180px;">
    <img src="images/act-3/3-first.png" alt="" style="float:right;width:180px;">
...
4.  Let’s bring up the network map of the changes you’ve made in your repository.
    ...
    <img src="images/act-3/3-2.gif" alt="" style="float:right;width:180px;">
